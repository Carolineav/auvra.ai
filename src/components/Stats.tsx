  ...
  return (
    <section className="py-20 bg-gradient-to-r from-gray-900 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-10 right-10 w-40 h-40 animate-float-delayed">
          <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        {/* Circuit patterns */}
        <div className="absolute top-1/2 left-20 w-2 h-32 bg-gradient-to-b from-cosmic-purple/30 to-transparent animate-circuit"></div>
        <div className="absolute top-1/2 left-20 w-32 h-2 bg-gradient-to-r from-cosmic-purple/30 to-transparent animate-circuit delay-500"></div>
        <div className="absolute top-1/2 right-20 w-2 h-24 bg-gradient-to-b from-cosmic-blue/30 to-transparent animate-circuit delay-1000"></div>
        <div className="absolute top-1/2 right-20 w-24 h-2 bg-gradient-to-l from-cosmic-blue/30 to-transparent animate-circuit delay-1500"></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-cosmic-purple/20 to-cosmic-blue/20 px-4 py-2 rounded-full border border-cosmic-purple/30 mb-6">
            ...
            <span className="text-cosmic-purple font-semibold">AI Performance Metrics</span>
            <Cpu className="w-4 h-4 text-cosmic-blue animate-pulse delay-500" />
          </div>
          <h2 className="text-4xl font-bold text-cosmic-purple mb-6">Results That Speak</h2>
          ...
          {stats.map((stat, index) => (
            <div key={index} className="text-center group relative">
              ...
              <div className="relative z-10">
                <div className="w-20 h-20 bg-gradient-to-br from-cosmic-purple to-cosmic-blue rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 ai-glow">
                  <stat.icon className="w-10 h-10 text-white animate-pulse" style={{animationDelay: `${index * 200}ms`}} />
                </div>
                <div className="text-4xl font-bold text-cosmic-purple mb-2 neural-glow">{stat.number}</div>
                <div className="text-xl font-semibold text-white mb-2">{stat.label}</div>
                <div className="text-gray-400 mb-3">{stat.description}</div>
        ...
        <div className="mt-16 pt-8 border-t border-cosmic-purple/20">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="group">
              <div className="flex items-center justify-center gap-2 mb-2">
                <Network className="w-6 h-6 text-cosmic-purple animate-pulse" />
                <span className="text-2xl font-bold text-cosmic-purple">50+</span>
              </div>
              <p className="text-gray-400">AI Models Trained</p>
            </div>
            <div className="group">
              <div className="flex items-center justify-center gap-2 mb-2">
                <Zap className="w-6 h-6 text-cosmic-blue animate-pulse delay-300" />
                <span className="text-2xl font-bold text-cosmic-blue">1M+</span>
              </div>
              <p className="text-gray-400">Automated Decisions</p>
            </div>
            <div className="group">
              <div className="flex items-center justify-center gap-2 mb-2">
                <Cpu className="w-6 h-6 text-cosmic-pink animate-pulse delay-600" />
                <span className="text-2xl font-bold text-cosmic-pink">99.9%</span>
              </div>
